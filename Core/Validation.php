<?php
    ...
    class Validation {
        ...
        public function exists($value, $array)
        {
            foreach ($array as $key) {
                foreach ($key as $prop){
                    if ($prop == $value){
                        $this->errors[] = $value.' existe déjà, veuillez en choisir un autre nom.';
                        return $this;
                    }
                }
            }
        ...
        public function maxSize($file, $size){
            if($file > $size){
                $this->errors[] = 'Le fichier dépasse la taille maximale de '.number_format($size / 1048576, 2).' MB.';
            }
        ...
        public function ext($file){
            ...
            if($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg"){
                $this->errors[] = 'Le format de l\'image n\'est pas valide. Seuls JPG, JPEG et PNG sont autorisés.';
            }
            return $this;
